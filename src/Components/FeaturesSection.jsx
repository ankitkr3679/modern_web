  ...
  return (
    <section id="about" className='max-w-7xl mx-auto px-4 py-16'>
      ...
      <div className='text-center mb-12'>
        <h2 className='text-2xl md:text-4xl font-bold text-neutral-900 mb-4'>How can we help your business?</h2>
      ...
      <div className='text-center mt-12'>
        <button className='bg-blue-600 text-white cursor-pointer px-8 py-3 rounded-full font-medium hover:bg-blue-700 transition-colors relative'>Learn More
